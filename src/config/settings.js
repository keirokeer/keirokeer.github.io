...
export const siteConfig = {
  ...
  // Настройки языка
  language: {
    enabled: true, // Включить переключение языков
    default: 'en', // Язык по умолчанию
    available: ['ru', 'fr', 'ja', 'ko', 'zh', 'pt-br', 'es', 'it', 'sr'] // Доступные дополнительные языки (через запятую)
    // Доступные коды: 'ru', 'fr', 'ja', 'ko', 'zh', 'pt-br', 'es', 'it', 'sr'
  },
